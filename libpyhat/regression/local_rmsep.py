        ...
        for win in windowsize:
            ...
            if sigma[0] > 0:
                ...
                if plot_file is not None:
                    plot.plot(dummypredicts_orig, dummy_rmseps_orig, linestyle='-', marker='o')  # plot the unsmoothed data
                    #mark the points that are not removed as duplicates
                    plot.plot(dummypredicts_presmooth, dummy_rmseps_presmooth, linestyle='-',marker='*',markersize=4,color = 'black')
